...
def duplicatefilter(extents):
    ...
    exist_extents = []
    marine12_extents = ParseMarine(r'E:\documentation\OneDrive\documentation\coordinates\marine_coord12')
    exist_extents = HRSC_extents + marine12_extents
    marine345_extents = ParseMarine(r'E:\documentation\OneDrive\documentation\coordinates\marine_coord345')
    exist_extents = exist_extents + marine345_extents
    outextents = []
...
def main():
    ...
    filepath = r'E:\documentation\OneDrive\documentation\coordinates\marine_coord6789'
    ...
    for index, extent in enumerate(filtered_extents):
        writekml(extent, os.path.join(r'E:\documentation\OneDrive\documentation\coordinates\marine_kml6789_level18',
                                      str(index) + '.kml'))
        writeltsk(selectlevel, os.path.join(r'E:\documentation\OneDrive\documentation\coordinates\marine_kml6789_level18',
                                            str(index) + '.ltsk'))
