...
def main():
    ...
    filepath = r'E:\documentation\OneDrive\documentation\coordinates\marine_coord345'
    ...
    for index, extent in enumerate(filtered_extents):
        writekml(extent, os.path.join(r'E:\documentation\OneDrive\documentation\coordinates\marine_kml345_level17',
                                      str(index) + '.kml'))
        writeltsk(selectlevel, os.path.join(r'E:\documentation\OneDrive\documentation\coordinates\marine_kml345_level17',
                                            str(index) + '.ltsk'))
